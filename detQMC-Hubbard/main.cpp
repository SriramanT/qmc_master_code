...
int main()
{
    ...
    typedef Eigen::Matrix<double, L, N> MatrixLN;
    typedef Eigen::Matrix<double, N, 1> ColVectorN;
    typedef Eigen::Matrix<double, 1, N> RowVectorN;
