...
public:
    void fillMatrices(bool spin, double nu, double dt, double mu, Eigen::Matrix<double, L, N> h, Eigen::Matrix<double, N, N> BpreFactor);
...
template<int N, int L>
void OneParticlePropagators<N, L>::fillMatrices(bool spin, double nu, double dt, double mu, Eigen::Matrix<double, L, N> h, Eigen::Matrix<double, N, N> BpreFactor)
{
    int i;
    int l;
    for (l = 0; l < L; l++)
