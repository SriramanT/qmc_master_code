...
#ifndef EDGESITES
#define EDGESITES 4 //  # first few sites of the edge
#endif
...
int main(int argc, char **argv)
{
    ...
    Eigen::MatrixXd magCorrZZs =
      Eigen::Matrix<double, 3* EDGESITES, 3* EDGESITES>::Zero();
    ...
    double energy;
    double zzMag;
    Eigen::MatrixXd magCorrZZ = Eigen::Matrix<double, 3 * EDGESITES, 3 * EDGESITES>::Zero();
    ...
    Eigen::MatrixXd SiSjZ =
      Eigen::Matrix<double, 3 * NSITES, 3 * NSITES>::Zero();
